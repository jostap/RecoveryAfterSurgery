...
queryList: [
  ...
  {id:"C2_0", id_display:"S1", query:"Att stå under längre perioder såsom 30 minuter? ", queryType:[{text:false, list:true, multiSelect:false}],
   ...
   {id:"C2_1", id_display:"S2", query:"Att ta hand om ditt hushåll?", queryType:[{text:false, list:true, multiSelect:false}],
    ...
    {id:"C2_3", id_display:"S1", query:"Att lära dig en ny uppgift (till exempel hur man tar sig till en ny plats)?", queryType:[{text:false, list:true, multiSelect:false}],
     alternatives:[
       {display:"Ingen", value:"0"},
       {display:"Liten", value:"1"},
       {display:"Måttlig", value:"2"},
     ...
     {id:"C2_4", id_display:"S1", query:"Hur stort problem har du haft med att delta i aktiviteter i samhället (till exempel festligheter, religiösa eller andra aktiviteter) på samma sätt som andra kan? ", queryType:[{text:false, list:true, multiSelect:false}],
      alternatives:[
        {display:"Ingen", value:"0"},
        {display:"Liten", value:"1"},
        {display:"Måttlig", value:"2"},
      ...
      {id:"C2_5", id_display:"S1", query:"Hur mycket har du påverkats känslomässigt av ditt hälsotillstånd?", queryType:[{text:false, list:true, multiSelect:false}],
       alternatives:[
         {display:"Ingen", value:"0"},
         {display:"Liten", value:"1"},
         {display:"Måttlig", value:"2"},
       ...
       {id:"C2_6", id_display:"S1", query:"Att koncentrera dig under tio minuter på att göra något? ", queryType:[{text:false, list:true, multiSelect:false}],
        alternatives:[
          {display:"Ingen", value:"0"},
          {display:"Liten", value:"1"},
          {display:"Måttlig", value:"2"},
        ...
        {id:"C2_7", id_display:"S1", query:"Att gå en längre sträcka såsom en kilometer? ", queryType:[{text:false, list:true, multiSelect:false}],
         alternatives:[
           {display:"Ingen", value:"0"},
           {display:"Liten", value:"1"},
           {display:"Måttlig", value:"2"},
         ...
         {id:"C2_8", id_display:"S1", query:"Att tvätta hela kroppen?", queryType:[{text:false, list:true, multiSelect:false}],
          alternatives:[
            {display:"Ingen", value:"0"},
            {display:"Liten", value:"1"},
            {display:"Måttlig", value:"2"},
          ...
          {id:"C2_9", id_display:"S1", query:"Klä dig?", queryType:[{text:false, list:true, multiSelect:false}],
           alternatives:[
             {display:"Ingen", value:"0"},
             {display:"Liten", value:"1"},
             {display:"Måttlig", value:"2"},
           ...
           {id:"C2_10", id_display:"S1", query:"Att bemöta människor som du inte känner? ", queryType:[{text:false, list:true, multiSelect:false}],
            alternatives:[
              {display:"Ingen", value:"0"},
              {display:"Liten", value:"1"},
              {display:"Måttlig", value:"2"},
            ...
            {id:"C2_11", id_display:"S1", query:"Att bibehålla en vänskapsrelation?", queryType:[{text:false, list:true, multiSelect:false}],
             alternatives:[
               {display:"Ingen", value:"0"},
               {display:"Liten", value:"1"},
               {display:"Måttlig", value:"2"},
             ...
             {id:"C2_12", id_display:"S1", query:"Ditt dagliga arbete eller studier?", queryType:[{text:false, list:true, multiSelect:false}],
              alternatives:[
                {display:"Ingen", value:"0"},
                {display:"Liten", value:"1"},
                {display:"Måttlig", value:"2"},
              ...
              {id:"C2_13", id_display:"H1", query:"Allt sammantaget, hur många av de senaste 30 dagarna har du haft dessa svårigheter? ", queryType:[{text:true, list:false, multiSelect:false}],"resStatus":false, "preValue":null},
              {id:"C2_14", id_display:"H2", query:"Hur många av de senaste 30 dagarna var du helt oförmögen att genomföra dina vanliga aktiviteter eller ditt arbete på grund av ditt hälsotillstånd? ", queryType:[{text:true, list:false, multiSelect:false}],"resStatus":false, "preValue":null},
              {id:"C2_15", id_display:"H3", query:"Om man inte räknar de dagar du var helt oförmögen, hur många av de senaste 30 dagarna skar du ned på eller minskade på dina vanliga aktiviteter eller ditt arbete på grund av ditt hälsotillstånd? ", queryType:[{text:true, list:false, multiSelect:false}],"resStatus":false, "preValue":null},
